...
import 'package:chat_flutter/common/widgets/toast.dart';
import 'package:chat_flutter/pages/signin/state.dart';
...
class SignInController extends GetxController {
  ...
  void onReady() {
    ...
    FirebaseAuth.instance.authStateChanges().listen((User? user) {
      if (user == null) {
        print('User currently logout');
      } else {
        print('User currently login');
      }
    });
  }
}
